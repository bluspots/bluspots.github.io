...
| `fixedCustomerLaborPrice` | number | ✅ resolved via `vjTask.p` / `custom.price` | ⚠️ `payout` (this is the *pro's* payout, not the customer's price — see next row) | Service price equals labor. Haven's cut is 20% of the labor price. The Pro receives 80%. The customer's listed labor price does not increase. The 20% comes out of the Pro's labor payout. The founder may change the labor cut later. |
| `fixedProLaborPayout` | number | ❌ not modeled (Customer App has no concept of what the pro earns) | ✅ `payout` | Haven's cut is 20% of the labor price. The Pro receives 80%. The customer's listed labor price does not increase. The 20% comes out of the Pro's labor payout. The founder may change the labor cut later. |
| `platformFee` | number | ❌ not present | ❌ not present | Not yet modeled on either side. Haven's cut is 20% of the labor price. The Pro receives 80%. The customer's listed labor price does not increase. The 20% comes out of the Pro's labor payout. The founder may change the labor cut later. |
...
- Pro receives: labor payout + 100% of materials + 100% of tips + any
  applicable diagnosis/service fee.
...
- Haven's cut is 20% of the labor price. The Pro receives 80%. The customer's listed labor price does not increase. The 20% comes out of the Pro's labor payout. The founder may change the labor cut later.

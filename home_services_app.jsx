...
export default function App(){
  ...
  const cancelJobDirect=async()=>{ 
    ...
    // Prototype backend dual-write (best-effort; narrow RLS allows posted → cancelled)
    if(vj.backendJobId){
      try{
        await updateCanonicalJob(vj.backendJobId,{status:"cancelled", cancelled_at:new Date().toISOString()});
      }catch(err){
        console.warn("Haven: cancel dual-write failed; proceeding locally.", err);
      }
    }

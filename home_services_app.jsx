...
const EMERGENCY_CATS=["Repair","Plumbing","Electrical"];
...
export default function App(){
  ...
  // Profile
  const [profile,setProfile]     = useState({name:"Jane Doe",bio:"",photo:null});
  ...
  const homeScreen=()=>{
    ...
    <div className="sc" style={{flex:1,overflowY:"auto",background:BG}}>
      ...
      <div style={{background:BG,borderRadius:"22px 22px 0 0",marginTop:-18,position:"relative",zIndex:1,padding:"20px 20px 24px"}}>
        ...
        <div onClick={openDiagnose} style={{background:W,borderRadius:20,padding:18,marginBottom:12,boxShadow:"0 2px 10px rgba(28,43,58,.07)",cursor:"pointer",display:"flex",gap:14,alignItems:"center"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:20}}>
          <div onClick={()=>goTo("emergency")} style={{background:"#FFF1EE",border:"1.5px solid #FFD4C7",borderRadius:16,padding:"16px 12px",cursor:"pointer",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",minHeight:88}}>
      ...
      <div className="sc" style={{flex:1,overflowY:"auto",background:BG}}>
        ...
        {items.length>0?(
          ...
          <div style={{textAlign:"center",padding:"40px 20px"}}>
            ...
            <div style={{fontWeight:600,color:TS,marginBottom:16}}>No services found</div>
            ...
            <div style={{background:W,borderRadius:20,padding:20,boxShadow:"0 2px 10px rgba(28,43,58,.07)"}}>
              ...
              <div style={{background:BG,borderRadius:16,padding:14,display:"flex",gap:12,alignItems:"center",marginBottom:16}}>
                ...
                <div style={{flex:1}}>
                  ...
                  <div style={{fontSize:12,color:TS,marginTop:1}}>est. {diagResult.task.t}</div>
                </div>
  ...
  const bookingsScreen=()=>{
    ...
    return(
      <div className="sc" style={{flex:1,overflowY:"auto",background:BG,padding:"20px 20px 100px"}}>
        ...
        {shownJobs.length===0?(
          <div style={{textAlign:"center",padding:"40px 20px"}}>
            <div style={{fontSize:40,marginBottom:12}}>{bFilter==="active"?"⏳":"✅"}</div>
            <div style={{fontWeight:600,color:TS}}>{bFilter==="active"?"No active jobs":"No completed jobs yet"}</div>
          </div>
        ):shownJobs.map(j=>{
  ...
  const profileScreen=()=>(
    <div className="sc" style={{flex:1,overflowY:"auto",padding:"20px 20px 100px",background:BG}}>
      ...
      <div onClick={openEditProfile} style={{background:N,borderRadius:20,padding:20,marginBottom:16,display:"flex",gap:14,alignItems:"center",cursor:"pointer"}}>
        <div style={{width:52,height:52,borderRadius:26,background:AM,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,overflow:"hidden"}}>
          {profile.photo?<img src={profile.photo} alt="" style={{width:"100%",height:"100%",objectFit:"cover"}}/>:<PersonIcon col={W} sz={30}/>}
        </div>
        <div style={{flex:1}}>
          <div style={{fontWeight:700,fontSize:16,color:W}}>{profile.name}</div>
          <div style={{color:"rgba(255,255,255,.55)",fontSize:13,marginTop:2}}>{profile.bio||"Member since 2024"}</div>
        </div>
    ...
    <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:BG}}>
      ...
      <div className="sc" style={{flex:1,overflowY:"auto",padding:20}}>
        ...
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",marginBottom:22}}>
          <div onClick={()=>profilePhotoInputRef.current?.click()} style={{width:88,height:88,borderRadius:44,background:AM,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",overflow:"hidden",position:"relative",marginBottom:10}}>
            {draftPhoto?<img src={draftPhoto} alt="" style={{width:"100%",height:"100%",objectFit:"cover"}}/>:<PersonIcon col={W} sz={40}/>}
          ...
          <span onClick={()=>profilePhotoInputRef.current?.click()} style={{fontSize:12,color:N,fontWeight:600,cursor:"pointer"}}>Tap to change photo</span>
        </div>
  ...
  const homeFieldCard=(label,children)=>(
    <div style={{background:W,borderRadius:18,padding:18,marginBottom:12,boxShadow:"0 2px 10px rgba(28,43,58,.07)"}}>
      ...
      <div className="sc" style={{flex:1,overflowY:"auto",padding:20}}>
        {completedJobs.length===0?(
          <div style={{background:W,borderRadius:18,padding:24,textAlign:"center",boxShadow:"0 2px 10px rgba(28,43,58,.07)"}}>
            ...
            <div style={{fontSize:13,color:TS,lineHeight:1.5}}>Receipts from completed jobs will appear here automatically.</div>
          </div>
        ):completedJobs.map(j=>{
          const jt=j.taskId?TASKS.find(t=>t.id===j.taskId):j.custom?{e:"🔧",n:j.custom.title,p:j.custom.price}:null;
          const jTotal=jt?jt.p+j.surge+(j.emergencyFee||0):0;
          ...
          return(
            <div key={j.id} style={{background:W,borderRadius:18,padding:16,marginBottom:12,boxShadow:"0 2px 10px rgba(28,43,58,.07)"}}>
              ...
              <button onClick={()=>openReceipt(j.id)} style={{width:"100%",padding:"10px 0",borderRadius:10,border:`1.5px solid ${BD}`,background:BG,color:TX,fontWeight:700,fontSize:12,cursor:"pointer"}}>View Receipt</button>
            </div>
          );
        })}
      </div>
        ...
        <div className="sc" style={{flex:1,overflowY:"auto",padding:20}}>
          <div className="receipt-print-area" style={{background:W,borderRadius:20,padding:22,boxShadow:"0 4px 20px rgba(28,43,58,.1)"}}>
            ...
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
              <span style={{fontSize:12,color:TS}}>Receipt ID</span>
            ...
            <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:16}}>
              <div style={{width:44,height:44,borderRadius:22,background:SL,display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{fontSize:22}}>{vjTask?vjTask.e:"🔧"}</span></div>
              <div style={{flex:1}}>
                <div style={{fontWeight:700,fontSize:15,color:TX}}>{vjTask?vjTask.n:"Custom job"}</div>
                <div style={{fontSize:12,color:TS,marginTop:1}}>Completed by {vjPro.n}</div>
              </div>
            </div>

            <div style={{marginBottom:8}}>
              <div style={{fontSize:11,fontWeight:700,color:TM,letterSpacing:.6,marginBottom:8}}>SERVICE ADDRESS</div>
              <div style={{fontSize:13,color:TX,marginBottom:16}}>{vj.addressText||"—"}</div>
            </div>

            <div style={{marginBottom:16}}>
              <div style={{fontSize:11,fontWeight:700,color:TM,letterSpacing:.6,marginBottom:10}}>CHARGES</div>
              {lineItems.map(([l,v])=>(
              ...
              <div style={{borderTop:`1px solid ${BD}`,marginTop:4,paddingTop:10,display:"flex",justifyContent:"space-between"}}>
                <span style={{fontSize:14,color:TX,fontWeight:800}}>Total paid</span>
                <span style={{fontSize:16,color:AM,fontWeight:900}}>${vjTotal}</span>
              </div>
            </div>

            <div style={{display:"flex",justifyContent:"space-between",marginBottom:8}}>
              <span style={{fontSize:12,color:TS}}>Payment method</span>
              <span style={{fontSize:12,color:TX,fontWeight:700}}>{vj.paymentBrand||"Card"} •••• {vj.paymentLast4||"----"}</span>
            </div>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:16}}>
              <span style={{fontSize:12,color:TS}}>Photos on file</span>
              <span style={{fontSize:12,color:TX,fontWeight:700}}>{vj.photos?.length>0?`${vj.photos.length} attached`:"None"}</span>
            </div>

            {vj.desc&&(
              <div style={{marginBottom:16}}>
                <div style={{fontSize:11,fontWeight:700,color:TM,letterSpacing:.6,marginBottom:6}}>JOB DESCRIPTION</div>
                <div style={{fontSize:13,color:TS,lineHeight:1.5}}>{vj.desc}</div>
              </div>
            )}
  ...
  const notifRow=(label,sub,k)=>(
    <div key={k} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"14px 0",borderBottom:`1px solid ${BD}`}}>
      ...
      <div onClick={()=>toggleNotif(k)} style={{width:44,height:26,borderRadius:13,background:notifPrefs[k]?AM:BD,position:"relative",cursor:"pointer",flexShrink:0}}>
          ...
          <div style={{background:N,padding:"14px 20px 34px"}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:14}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                <div style={{color:"rgba(255,255,255,.5)",fontSize:12,marginTop:2}}>Fixed price · est. {browsedTask.t}</div>
              </div>
              <div style={{textAlign:"right",flexShrink:0}}>
  ...
  const trackMap=()=>{
    ...
    return(
      <svg width="100%" height="185" viewBox="0 0 350 185" style={{display:"block"}}>
        ...
        {vj?.status==="en_route"&&<><rect x={px-2} y="50" width="90" height="21" rx="10" fill={AM}/><text x={px+43} y="65" textAnchor="middle" fontSize="11" fill={W} fontWeight="700">12 min away</text></>}
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:BG}}>
        ...
        <div className="sc" style={{flex:1,overflowY:"auto"}}>
          <div style={{margin:"14px 20px 0",background:W,borderRadius:20,padding:"16px 18px",boxShadow:"0 2px 10px rgba(28,43,58,.07)",display:"flex",gap:14,alignItems:"center"}}>
            ...
            <div><div style={{fontWeight:800,fontSize:17,color:TX,marginBottom:3}}>{info.label}</div><div style={{fontSize:13,color:TS}}>{vjPname} {info.sub}</div></div>
          </div>
      ...
      <div className="haven-frame-outer" style={{minHeight:"100vh",background:"linear-gradient(155deg,#B8C6D1 0%,#C8BBA8 100%)",display:"flex",alignItems:"center",justifyContent:"center",padding:20,fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif"}}>
        <div className="haven-frame-phone" style={{width:390,height:844,background:BG,borderRadius:46,overflow:"hidden",boxShadow:"0 32px 80px rgba(28,43,58,.28),0 0 0 1px rgba(28,43,58,.09)",display:"flex",flexDirection:"column"}}>
          ...
          <div style={{flex:1,overflow:"hidden",display:"flex",flexDirection:"column"}}>
            ...
            {scr==="diagnose" &&diagnoseScreen()}
            {scr==="emergency" &&emergencyScreen()}
            {scr==="home"     &&tab==="bookings" &&bookingsScreen()}
            {scr==="home"     &&tab==="profile"  &&profileScreen()}
            {scr==="task"     &&taskScreen()}
            {scr==="custom"   &&customScreen()}
            {scr==="posted"   &&postedScreen()}
            {scr==="tracking" &&trackingScreen()}
            {scr==="messages" &&messagesScreen()}
            {scr==="rating"   &&ratingScreen()}

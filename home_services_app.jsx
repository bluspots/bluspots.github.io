...
const PERSISTED_KEYS = ["haven_theme","haven_notifications","haven_notif_prefs","haven_jobs","haven_addresses","haven_cards","haven_profile","haven_draft"];
...
export default function App(){
  ...
  const resetPrototypeData=()=>{
    ...
    setProfile({name:"Jane Doe",bio:"",photo:null});
    setNotifications([]);
  ...
  // Profile
  const DEFAULT_PROFILE={name:"Jane Doe",bio:"",photo:null};
